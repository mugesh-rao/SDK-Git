...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   dropdown: () => (/* binding */ dropdown)\n/* harmony export */ });\nfunction dropdown(\r\n\toptionsList = [\r\n\t\t{ name: \"Current Notifications\", value: \"currentNotifications\" },\r\n\t\t{ name: \"Notification History\", value: \"notificationHistory\" },\r\n\t],\r\n\tselected = \"currentNotifications\",\r\n\tevents = {\r\n\t\titemClicked: function () {},\r\n\t}\r\n\t// disabled = false\r\n) {\r\n\tconst dropdown = document.createElement(\"div\");\r\n\tdropdown.classList.add(\"dropdown-component-wrapper\");\r\n\tdropdown.setAttribute(\"tabindex\", -1);\r\n\t// disabled && (dropdown.style.pointerEvents = \"none\");\r\n\r\n\tdropdown.innerHTML = `\r\n         <div class=\"dropdown-box\">\r\n          <div class=\"selected\">${optionsList.find((item) => item.value == selected)?.name}</div>\r\n         \r\n        </div>\r\n        <div class=\"dropdown-menu\">\r\n          \r\n        </div>\r\n        `;\r\n\r\n\tconst dropdownBox = dropdown.querySelector(\".dropdown-box\");\r\n\tconst dropdownMenu = dropdown.querySelector(\".dropdown-menu\");\r\n\tconst dropdownToggleIcon = document.createElement(\"div\");\r\n\tdropdownToggleIcon.classList.add(\"toggle-icon\");\r\n\tdropdownToggleIcon.innerHTML = `<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"25\" viewBox=\"0 0 24 25\" fill=\"none\">\r\n            <path fill-rule=\"evenodd\" clip-rule=\"evenodd\" d=\"M5.39886 8.89886C5.73081 8.56692 6.269 8.56692 6.60094 8.89886L11.9999 14.2978L17.3989 8.89886C17.7308 8.56692 18.269 8.56692 18.6009 8.89886C18.9329 9.23081 18.9329 9.769 18.6009 10.1009L12.6009 16.1009C12.269 16.4329 11.7308 16.4329 11.3989 16.1009L5.39886 10.1009C5.06692 9.769 5.06692 9.23081 5.39886 8.89886Z\" fill=\"#808080\" />\r\n        </svg>`;\r\n\r\n\tdropdownBox.appendChild(dropdownToggleIcon);\r\n\tdropdown.addEventListener(\"blur\", () => {\r\n\t\t// console.log(dropdown.classList);\r\n\t\tdropdown.classList.remove(\"is-open\");\r\n\t});\r\n\r\n\tdropdownBox.addEventListener(\"click\", (e) => {\r\n\t\te.preventDefault();\r\n\t\tdropdown.classList.toggle(\"is-open\");\r\n\t});\r\n\r\n\tdropdownMenu.addEventListener(\"click\", (e) => {\r\n\t\te.preventDefault();\r\n\t});\r\n\r\n\toptionsList.forEach((option) => {\r\n\t\tconst menuItem = document.createElement(\"div\");\r\n\t\tmenuItem.textContent = option.name;\r\n\t\tmenuItem.classList.add(\"menu-item\");\r\n\t\tmenuItem.addEventListener(\"click\", () => {\r\n\t\t\tdropdown.querySelector(\".selected\").textContent = option.name;\r\n\t\t\tdropdown.classList.remove(\"is-open\");\r\n\t\t\tevents.itemClicked(option);\r\n\t\t});\r\n\r\n\t\tdropdownMenu.appendChild(menuItem);\r\n\t});\r\n\r\n\treturn dropdown;\r\n}\r\n\n\n//# sourceURL=webpack://kale/./ui/components/dropdown.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   multiNotificationComponent: () => (/* binding */ multiNotificationComponent)\n/* harmony export */ });\n/* harmony import */ var _singleNotificationComponent_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./singleNotificationComponent.js */ \"./ui/components/singleNotificationComponent.js\");\n/* harmony import */ var _dropdown_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dropdown.js */ \"./ui/components/dropdown.js\");\n/* harmony import */ var _buttons_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./buttons.js */ \"./ui/components/buttons.js\");\n/* harmony import */ var _chips_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chips.js */ \"./ui/components/chips.js\");\n/* harmony import */ var joi__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! joi */ \"./node_modules/joi/dist/joi-browser.min.js\");\n/* harmony import */ var _commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../commonUtilities.js */ \"./ui/commonUtilities.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nfunction multiNotificationComponent(notifications = {}, notificationContainer, companyId, userEmail) {\r\n\tconst appendParent =\r\n\t\tnotificationContainer instanceof HTMLElement ? container : document.querySelector(notificationContainer);\r\n\t// console.log(appendParent)\r\n// Add this inside the multiNotificationComponent function\r\nconst unseenCount = notifications?.UNSEEN?.length || 0;\r\nconsole.log(unseenCount)\r\n// Assuming you have a badge element with the id \"notification-badge\"\r\nconst badgeElement = document.getElementById(\"notification-badge\");\r\nif (badgeElement) {\r\n    badgeElement.textContent = unseenCount;\r\n}\r\n\r\n\tif (appendParent) {\r\n\t\tappendParent.innerHTML = \"\";\r\n\t\tconst notificationHistoryContainer = document.createElement(\"div\");\r\n\t\tnotificationHistoryContainer.classList.add(\"notification-history-container\");\r\n\r\n\t\tnotificationHistoryContainer.innerHTML = `\r\n        <div class=\"notification-history-filters\">\r\n\r\n        </div>\r\n        <div class=\"notification-chips-options\">\r\n\r\n        </div>\r\n        <div class=\"notifications-list-container\"></div>\r\n      `;\r\n\t\tconst noNotifications = document.createElement(\"div\");\r\n\t\tnoNotifications.classList.add(\"no-notifications-message\");\r\n\t\tnoNotifications.innerHTML = \"No notifications.\";\r\n\t\t// ....................\r\n\t\tconst notificationsListContainer = notificationHistoryContainer.querySelector(\".notifications-list-container\");\r\n\r\n\t\tconst filterDropdownContainer = notificationHistoryContainer.querySelector(\".notification-history-filters\");\r\n\r\n\t\tconst optionsList = [\r\n\t\t\t{ name: \"Current Notifications\", value: \"currentNotifications\" },\r\n\t\t\t{ name: \"Notification History\", value: \"notificationHistory\" },\r\n\t\t];\r\n\r\n\t\tif (!(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getDropdownState)()) {\r\n\t\t\t(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.setDropdownState)(\"currentNotifications\");\r\n\t\t}\r\n\r\n\t\t// .............\r\n\t\t// chips.......\r\n\r\n\t\tconst notificationChipsOptions = notificationHistoryContainer.querySelector(\".notification-chips-options\");\r\n\t\t// console.log(notifications)\r\n\t\tconst currentNotificationChipsOptions = [\r\n\t\t\t{ name: \"Active\", value: \"UNSEEN\", classes: [], qty: notifications.UNSEEN?.length || 0 },\r\n\t\t\t{ name: \"Snoozed\", value: \"SNOOZED\", classes: [], qty: notifications.SNOOZED?.length || 0 },\r\n\t\t\t{ name: \"Ignored\", value: \"IGNORED\", classes: [], qty: notifications.IGNORED?.length || 0 },\r\n\t\t\t{\r\n\t\t\t\tname: \"All\",\r\n\t\t\t\tvalue: \"all\",\r\n\t\t\t\tclasses: [],\r\n\t\t\t\tqty:\r\n\t\t\t\t\t(notifications.UNSEEN?.length || 0) +\r\n\t\t\t\t\t(notifications.SNOOZED?.length || 0) +\r\n\t\t\t\t\t(notifications.IGNORED?.length || 0),\r\n\t\t\t},\r\n\t\t];\r\n\t\tconst historyChipsOptions = [\r\n\t\t\t{\r\n\t\t\t\tname: \"All\",\r\n\t\t\t\tvalue: \"all\",\r\n\t\t\t\tclasses: [],\r\n\t\t\t\tqty: (notifications?.COMPLETED?.length || 0) + (notifications?.IN_PROGRESS?.length || 0),\r\n\t\t\t},\r\n\t\t\t{\r\n\t\t\t\tname: \"Completed\",\r\n\t\t\t\tvalue: \"COMPLETED\",\r\n\t\t\t\tclasses: [\"completed-selected\"],\r\n\t\t\t\tqty: notifications?.COMPLETED?.length || 0,\r\n\t\t\t},\r\n\t\t\t{\r\n\t\t\t\tname: \"In progress\",\r\n\t\t\t\tvalue: \"IN_PROGRESS\",\r\n\t\t\t\tclasses: [\"in-process-selected\"],\r\n\t\t\t\tqty: notifications?.IN_PROGRESS?.length || 0,\r\n\t\t\t},\r\n\t\t];\r\n\r\n\t\tconst chipsList =\r\n\t\t\t(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getDropdownState)() == \"currentNotifications\" ? currentNotificationChipsOptions : historyChipsOptions;\r\n\r\n\t\tif (!(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)()) {\r\n\t\t\t(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.setNotificationFilter)(chipsList[0].value);\r\n\t\t}\r\n\r\n\t\tconst eventsForChips = {\r\n\t\t\titemClicked: function (item) {\r\n\t\t\t\t(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.setNotificationFilter)(item.value);\r\n\t\t\t\tnotificationsListContainer.innerHTML = \"\";\r\n\t\t\t\tlet iterableNotifications = [];\r\n\t\t\t\tif ((0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)() == \"all\") {\r\n\t\t\t\t\tif ((0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getDropdownState)() == \"currentNotifications\") {\r\n\t\t\t\t\t\tnotifications?.UNSEEN &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.UNSEEN]);\r\n\t\t\t\t\t\tnotifications?.SNOOZED &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.SNOOZED]);\r\n\t\t\t\t\t\tnotifications?.IGNORED &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.IGNORED]);\r\n\t\t\t\t\t\t\tconsole.log(\"Unseen Notifications: \", notifications?.UNSEEN);\r\n\t\t\t\t\t} else {\r\n\t\t\t\t\t\tnotifications?.COMPLETED &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.COMPLETED]);\r\n\t\t\t\t\t\tnotifications?.IN_PROGRESS &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.IN_PROGRESS]);\r\n\t\t\t\t\t}\r\n\t\t\t\t} else {\r\n\t\t\t\t\titerableNotifications = notifications?.[(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)()];\r\n\t\t\t\t}\r\n\r\n\t\t\t\tif (iterableNotifications?.length) {\r\n\t\t\t\t\titerableNotifications?.forEach((notification) => {\r\n\t\t\t\t\t\t(0,_singleNotificationComponent_js__WEBPACK_IMPORTED_MODULE_0__.addSingleNotificationContainer)(notification, notificationsListContainer, companyId, userEmail);\r\n\t\t\t\t\t});\r\n\t\t\t\t} else {\r\n\t\t\t\t\tnotificationsListContainer.append(noNotifications);\r\n\t\t\t\t}\r\n\t\t\t},\r\n\t\t};\r\n\r\n\t\tnotificationChipsOptions.innerHTML = \"\";\r\n\t\tconst chipsContainer = (0,_chips_js__WEBPACK_IMPORTED_MODULE_3__.chips)(chipsList, (0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)(), eventsForChips);\r\n\t\tnotificationChipsOptions.appendChild(chipsContainer);\r\n\r\n\t\t// ............\r\n\t\tconst events = {\r\n\t\t\titemClicked: function (item) {\r\n\t\t\t\t// console.log(item)\r\n\t\t\t\t(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.setDropdownState)(item.value);\r\n\t\t\t\tnotificationChipsOptions.innerHTML = \"\";\r\n\t\t\t\tconst chipsList =\r\n\t\t\t\t\titem.value == \"currentNotifications\" ? currentNotificationChipsOptions : historyChipsOptions;\r\n\t\t\t\t(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.setNotificationFilter)(chipsList[0].value);\r\n\t\t\t\tconst chipsContainer = (0,_chips_js__WEBPACK_IMPORTED_MODULE_3__.chips)(chipsList, (0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)(), eventsForChips);\r\n\t\t\t\tnotificationChipsOptions.appendChild(chipsContainer);\r\n\r\n\t\t\t\tnotificationsListContainer.innerHTML = \"\";\r\n\t\t\t\tlet iterableNotifications = [];\r\n\t\t\t\tif ((0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)() == \"all\") {\r\n\t\t\t\t\tif ((0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getDropdownState)() == \"currentNotifications\") {\r\n\t\t\t\t\t\tnotifications?.UNSEEN &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.UNSEEN]);\r\n\t\t\t\t\t\tnotifications?.SNOOZED &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.SNOOZED]);\r\n\t\t\t\t\t\tnotifications?.IGNORED &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.IGNORED]);\r\n\t\t\t\t\t} else {\r\n\t\t\t\t\t\tnotifications?.COMPLETED &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.COMPLETED]);\r\n\t\t\t\t\t\tnotifications?.IN_PROGRESS &&\r\n\t\t\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.IN_PROGRESS]);\r\n\t\t\t\t\t}\r\n\t\t\t\t} else {\r\n\t\t\t\t\titerableNotifications = notifications?.[(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)()];\r\n\t\t\t\t}\r\n\r\n\t\t\t\tif (iterableNotifications?.length) {\r\n\t\t\t\t\titerableNotifications?.forEach((notification) => {\r\n\t\t\t\t\t\t(0,_singleNotificationComponent_js__WEBPACK_IMPORTED_MODULE_0__.addSingleNotificationContainer)(notification, notificationsListContainer, companyId, userEmail);\r\n\t\t\t\t\t});\r\n\t\t\t\t} else {\r\n\t\t\t\t\tnotificationsListContainer.append(noNotifications);\r\n\t\t\t\t}\r\n\t\t\t},\r\n\t\t};\r\n\r\n\t\tconst dropdownComponent = (0,_dropdown_js__WEBPACK_IMPORTED_MODULE_1__.dropdown)(optionsList, (0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getDropdownState)(), events);\r\n\r\n\t\tfilterDropdownContainer.appendChild(dropdownComponent);\r\n\t\t// ....................\r\n\r\n\t\t// const closeBtnEvents = [{ type: 'click', cb: (event) => { event.preventDefault(); console.log('closeFilterBtn') } }]\r\n\t\t// const minimizeBtnEvents = [{ type: 'click', cb: (event) => { event.preventDefault(); console.log('minimizeFilterBtn') } }]\r\n\t\t// const bellBtnEvents = [{ type: 'click', cb: (event) => { event.preventDefault(); console.log('bellFilterBtn') } }]\r\n\r\n\t\t// filterBtnsContainer.appendChild(createButton('closeFilterBtn', ['filter-btn'], closeBtnEvents))\r\n\t\t// filterBtnsContainer.appendChild(createButton('minimizeFilterBtn', ['filter-btn'], minimizeBtnEvents))\r\n\t\t// filterBtnsContainer.appendChild(createButton('bellFilterBtn', ['filter-btn'], bellBtnEvents))\r\n\r\n\t\tlet iterableNotifications = [];\r\n\t\tif ((0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)() == \"all\") {\r\n\t\t\tif ((0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getDropdownState)() == \"currentNotifications\") {\r\n\t\t\t\tnotifications?.UNSEEN && (iterableNotifications = [...iterableNotifications, ...notifications?.UNSEEN]);\r\n\t\t\t\tnotifications?.SNOOZED &&\r\n\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.SNOOZED]);\r\n\t\t\t\tnotifications?.IGNORED &&\r\n\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.IGNORED]);\r\n\t\t\t} else {\r\n\t\t\t\tnotifications?.COMPLETED &&\r\n\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.COMPLETED]);\r\n\t\t\t\tnotifications?.IN_PROGRESS &&\r\n\t\t\t\t\t(iterableNotifications = [...iterableNotifications, ...notifications?.IN_PROGRESS]);\r\n\t\t\t}\r\n\t\t} else {\r\n\t\t\titerableNotifications = notifications?.[(0,_commonUtilities_js__WEBPACK_IMPORTED_MODULE_5__.getNotificationFilter)()];\r\n\t\t}\r\n\r\n\t\tif (iterableNotifications?.length) {\r\n\t\t\titerableNotifications?.forEach((notification) => {\r\n\t\t\t\t(0,_singleNotificationComponent_js__WEBPACK_IMPORTED_MODULE_0__.addSingleNotificationContainer)(notification, notificationsListContainer, companyId, userEmail);\r\n\t\t\t});\r\n\t\t} else {\r\n\t\t\tnotificationsListContainer.append(noNotifications);\r\n\t\t}\r\n\t\tappendParent.appendChild(notificationHistoryContainer);\r\n\t} else {\r\n\t\tconsole.error(\"parent not found.\");\r\n\t}\r\n}\r\n\n\n//# sourceURL=webpack://kale/./ui/components/multiNotificationComponent.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   dropdownStyles: () => (/* binding */ dropdownStyles)\n/* harmony export */ });\n/* harmony import */ var _globalStyles_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./globalStyles.js */ \"./ui/styles/globalStyles.js\");\n\r\n\r\nconst dropdownStyles = `\r\n  .dropdown-component-wrapper {\r\n    display: flex;\r\n    flex-direction: column;\r\n    gap: 0.125rem;\r\n    min-width: 12.5rem;\r\n    position: relative;\r\n    z-index: 5;\r\n  }\r\n\r\n  .dropdown-component-wrapper .dropdown-box {\r\n    display: flex;\r\n    gap: 0.625rem;\r\n    align-items: center;\r\n    justify-content: space-between;\r\n    padding: 0.5rem 0.625rem;\r\n    background-color: transparent;\r\n    cursor: pointer;\r\n    border: 2px solid ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.color2};\r\n    border-radius: 9px;\r\n    transition: all 0.3s ease;\r\n  }\r\n\r\n  .dropdown-component-wrapper .dropdown-box .selected {\r\n    font-size: 0.875rem;\r\n    color: ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.colorBlack};\r\n    font-weight: 600;\r\n    flex-grow: 1;\r\n    overflow: hidden;\r\n    text-overflow: ellipsis;\r\n    white-space: nowrap;\r\n  }\r\n\r\n  .dropdown-component-wrapper .dropdown-menu {\r\n    border-radius: 8px;\r\n    border: 0.5px solid ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.color2};\r\n    background: ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.backgroundWhite};\r\n    display: none;\r\n    flex-direction: column;\r\n    overflow-y: auto;\r\n    padding-left: 0.25rem;\r\n    position: absolute;\r\n    top: 10%;\r\n    left: 0;\r\n    width: 100%;\r\n    max-height: 200px;\r\n    z-index: 10;\r\n    box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);\r\n  }\r\n\r\n  .dropdown-component-wrapper .dropdown-menu .menu-item {\r\n    font-size: 0.875rem;\r\n    padding: 0.5rem .625rem;\r\n    cursor: pointer;\r\n    transition: background-color 0.3s ease;\r\n  }\r\n\r\n  .dropdown-component-wrapper .dropdown-menu .menu-item:hover {\r\n    background-color: ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.backgroundColor2};\r\n  }\r\n\r\n  .dropdown-component-wrapper.is-open .dropdown-menu {\r\n    display: flex;\r\n  }\r\n\r\n  .dropdown-component-wrapper.is-open .dropdown-box .toggle-icon {\r\n    transform: rotate(-180deg);\r\n  }\r\n\r\n  .dropdown-component-wrapper .dropdown-box:focus {\r\n    outline: none;\r\n    box-shadow: 0 0 0 2px ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.color2};\r\n  }\r\n\r\n  .dropdown-component-wrapper:focus-within .dropdown-box {\r\n    outline: none;\r\n    box-shadow: 0 0 0 2px ${_globalStyles_js__WEBPACK_IMPORTED_MODULE_0__.colors.color2};\r\n  }\r\n`;\n\n//# sourceURL=webpack://kale/./ui/styles/dropDownStyle.js?");
